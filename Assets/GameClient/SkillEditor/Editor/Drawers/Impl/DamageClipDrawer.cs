...
{
    [CustomDrawer(typeof(DamageClip))]
    public class DamageClipDrawer : ClipDrawer
    {
        ...
        {
            var damageClip = clip as DamageClip;
        ...
        private void GetMatrix(DamageClip clip, SkillEditorState state, out Vector3 pos, out Quaternion rot)
        {

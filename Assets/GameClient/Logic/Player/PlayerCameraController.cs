    ...
    public class PlayerCameraController : MonoBehaviour, ICameraController
    {
        ...
        private void Awake()
        {
            if (UnityEngine.Camera.main != null)
            {
                ...
                {
                    Debug.LogError("[PlayerCameraController] 严重配置错误：当前主相机(Tag为MainCamera)上未找到 CinemachineBrain 组件！\nCinemachine 的虚拟相机必须依靠主相机上的 Brain 引擎来驱动，否则画面永远不会动。");
                }
            }
        }
        ...
        private void Start()
        {
            ...
            if (VirtualCamera != null)
            {
                ...
                VirtualCamera.LookAt = aim?? this.transform;
            }
        }
        ...
        public void EnableInput(bool enable)
        {
            if (VirtualCamera != null)
            {
                ...
                var inputProvider = VirtualCamera.GetComponent<CinemachineInputProvider>();

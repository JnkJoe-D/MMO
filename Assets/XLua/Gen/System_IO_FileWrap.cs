...
namespace XLua.CSObjectWrap
{
    ...
    public class SystemIOFileWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "ReadAllTextAsync", _m_ReadAllTextAsync_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "WriteAllTextAsync", _m_WriteAllTextAsync_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "ReadAllBytesAsync", _m_ReadAllBytesAsync_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "WriteAllBytesAsync", _m_WriteAllBytesAsync_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "ReadAllLinesAsync", _m_ReadAllLinesAsync_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "WriteAllLinesAsync", _m_WriteAllLinesAsync_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "AppendAllTextAsync", _m_AppendAllTextAsync_xlua_st_);
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = System.IO.File.OpenText( _path );
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = System.IO.File.CreateText( _path );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = System.IO.File.AppendText( _path );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = System.IO.File.Create( _path );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)) 
                {
                    ...
                    int _bufferSize = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        var gen_ret = System.IO.File.Create( _path, _bufferSize );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& translator.Assignable<System.IO.FileOptions>(L, 3)) 
                {
                    ...
                    System.IO.FileOptions _options;translator.Get(L, 3, out _options);
                        ...
                        var gen_ret = System.IO.File.Create( _path, _bufferSize, _options );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 4&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& translator.Assignable<System.IO.FileOptions>(L, 3)&& translator.Assignable<System.Security.AccessControl.FileSecurity>(L, 4)) 
                {
                    ...
                    System.Security.AccessControl.FileSecurity _fileSecurity = (System.Security.AccessControl.FileSecurity)translator.GetObject(L, 4, typeof(System.Security.AccessControl.FileSecurity));
                        ...
                        var gen_ret = System.IO.File.Create( _path, _bufferSize, _options, _fileSecurity );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = System.IO.File.Exists( _path );
		    ...
		    try {
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& translator.Assignable<System.IO.FileMode>(L, 2)) 
                {
                    ...
                    System.IO.FileMode _mode;translator.Get(L, 2, out _mode);
                        ...
                        var gen_ret = System.IO.File.Open( _path, _mode );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& translator.Assignable<System.IO.FileMode>(L, 2)&& translator.Assignable<System.IO.FileAccess>(L, 3)) 
                {
                    ...
                    System.IO.FileAccess _access;translator.Get(L, 3, out _access);
                        ...
                        var gen_ret = System.IO.File.Open( _path, _mode, _access );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 4&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& translator.Assignable<System.IO.FileMode>(L, 2)&& translator.Assignable<System.IO.FileAccess>(L, 3)&& translator.Assignable<System.IO.FileShare>(L, 4)) 
                {
                    ...
                    System.IO.FileShare _share;translator.Get(L, 4, out _share);
                        ...
                        var gen_ret = System.IO.File.Open( _path, _mode, _access, _share );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = System.IO.File.GetCreationTime( _path );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = System.IO.File.GetCreationTimeUtc( _path );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = System.IO.File.GetLastAccessTime( _path );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = System.IO.File.GetLastAccessTimeUtc( _path );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = System.IO.File.GetLastWriteTime( _path );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = System.IO.File.GetLastWriteTimeUtc( _path );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = System.IO.File.GetAttributes( _path );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = System.IO.File.OpenRead( _path );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = System.IO.File.OpenWrite( _path );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = System.IO.File.ReadAllText( _path );
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& translator.Assignable<System.Text.Encoding>(L, 2)) 
                {
                    ...
                    System.Text.Encoding _encoding = (System.Text.Encoding)translator.GetObject(L, 2, typeof(System.Text.Encoding));
                        ...
                        var gen_ret = System.IO.File.ReadAllText( _path, _encoding );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = System.IO.File.ReadAllBytes( _path );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = System.IO.File.ReadAllLines( _path );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& translator.Assignable<System.Text.Encoding>(L, 2)) 
                {
                    ...
                    System.Text.Encoding _encoding = (System.Text.Encoding)translator.GetObject(L, 2, typeof(System.Text.Encoding));
                        ...
                        var gen_ret = System.IO.File.ReadAllLines( _path, _encoding );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = System.IO.File.ReadLines( _path );
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& translator.Assignable<System.Text.Encoding>(L, 2)) 
                {
                    ...
                    System.Text.Encoding _encoding = (System.Text.Encoding)translator.GetObject(L, 2, typeof(System.Text.Encoding));
                        ...
                        var gen_ret = System.IO.File.ReadLines( _path, _encoding );
                        translator.PushAny(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ReadAllTextAsync_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& translator.Assignable<System.Threading.CancellationToken>(L, 2)) 
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                    System.Threading.CancellationToken _cancellationToken;translator.Get(L, 2, out _cancellationToken);
                    
                        var gen_ret = System.IO.File.ReadAllTextAsync( _path, _cancellationToken );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = System.IO.File.ReadAllTextAsync( _path );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& translator.Assignable<System.Text.Encoding>(L, 2)&& translator.Assignable<System.Threading.CancellationToken>(L, 3)) 
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                    System.Text.Encoding _encoding = (System.Text.Encoding)translator.GetObject(L, 2, typeof(System.Text.Encoding));
                    System.Threading.CancellationToken _cancellationToken;translator.Get(L, 3, out _cancellationToken);
                    
                        var gen_ret = System.IO.File.ReadAllTextAsync( _path, _encoding, _cancellationToken );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& translator.Assignable<System.Text.Encoding>(L, 2)) 
                {
                    ...
                    System.Text.Encoding _encoding = (System.Text.Encoding)translator.GetObject(L, 2, typeof(System.Text.Encoding));
                        ...
                        var gen_ret = System.IO.File.ReadAllTextAsync( _path, _encoding );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.IO.File.ReadAllTextAsync!");
            
        }
        
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_WriteAllTextAsync_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& translator.Assignable<System.Threading.CancellationToken>(L, 3)) 
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                    string _contents = LuaAPI.lua_tostring(L, 2);
                    System.Threading.CancellationToken _cancellationToken;translator.Get(L, 3, out _cancellationToken);
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    string _contents = LuaAPI.lua_tostring(L, 2);
                        ...
                        var gen_ret = System.IO.File.WriteAllTextAsync( _path, _contents );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 4&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& translator.Assignable<System.Text.Encoding>(L, 3)&& translator.Assignable<System.Threading.CancellationToken>(L, 4)) 
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                    string _contents = LuaAPI.lua_tostring(L, 2);
                    System.Text.Encoding _encoding = (System.Text.Encoding)translator.GetObject(L, 3, typeof(System.Text.Encoding));
                    System.Threading.CancellationToken _cancellationToken;translator.Get(L, 4, out _cancellationToken);
                        ...
                        var gen_ret = System.IO.File.WriteAllTextAsync( _path, _contents, _encoding, _cancellationToken );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& translator.Assignable<System.Text.Encoding>(L, 3)) 
                {
                    ...
                    System.Text.Encoding _encoding = (System.Text.Encoding)translator.GetObject(L, 3, typeof(System.Text.Encoding));
                        ...
                        var gen_ret = System.IO.File.WriteAllTextAsync( _path, _contents, _encoding );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.IO.File.WriteAllTextAsync!");
            
        }
        
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ReadAllBytesAsync_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& translator.Assignable<System.Threading.CancellationToken>(L, 2)) 
                {
                    ...
                    System.Threading.CancellationToken _cancellationToken;translator.Get(L, 2, out _cancellationToken);
                        ...
                        var gen_ret = System.IO.File.ReadAllBytesAsync( _path, _cancellationToken );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = System.IO.File.ReadAllBytesAsync( _path );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.IO.File.ReadAllBytesAsync!");
            
        }
        
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_WriteAllBytesAsync_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& translator.Assignable<System.Threading.CancellationToken>(L, 3)) 
                {
                    ...
                    System.Threading.CancellationToken _cancellationToken;translator.Get(L, 3, out _cancellationToken);
                        ...
                        var gen_ret = System.IO.File.WriteAllBytesAsync( _path, _bytes, _cancellationToken );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    byte[] _bytes = LuaAPI.lua_tobytes(L, 2);
                        ...
                        var gen_ret = System.IO.File.WriteAllBytesAsync( _path, _bytes );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.IO.File.WriteAllBytesAsync!");
            
        }
        
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ReadAllLinesAsync_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& translator.Assignable<System.Threading.CancellationToken>(L, 2)) 
                {
                    ...
                    System.Threading.CancellationToken _cancellationToken;translator.Get(L, 2, out _cancellationToken);
                        ...
                        var gen_ret = System.IO.File.ReadAllLinesAsync( _path, _cancellationToken );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = System.IO.File.ReadAllLinesAsync( _path );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& translator.Assignable<System.Text.Encoding>(L, 2)&& translator.Assignable<System.Threading.CancellationToken>(L, 3)) 
                {
                    ...
                    System.Threading.CancellationToken _cancellationToken;translator.Get(L, 3, out _cancellationToken);
                        ...
                        var gen_ret = System.IO.File.ReadAllLinesAsync( _path, _encoding, _cancellationToken );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& translator.Assignable<System.Text.Encoding>(L, 2)) 
                {
                    ...
                    System.Text.Encoding _encoding = (System.Text.Encoding)translator.GetObject(L, 2, typeof(System.Text.Encoding));
                        ...
                        var gen_ret = System.IO.File.ReadAllLinesAsync( _path, _encoding );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.IO.File.ReadAllLinesAsync!");
            
        }
        
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_WriteAllLinesAsync_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& translator.Assignable<System.Collections.Generic.IEnumerable<string>>(L, 2)&& translator.Assignable<System.Threading.CancellationToken>(L, 3)) 
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                    System.Collections.Generic.IEnumerable<string> _contents = (System.Collections.Generic.IEnumerable<string>)translator.GetObject(L, 2, typeof(System.Collections.Generic.IEnumerable<string>));
                    System.Threading.CancellationToken _cancellationToken;translator.Get(L, 3, out _cancellationToken);
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& translator.Assignable<System.Collections.Generic.IEnumerable<string>>(L, 2)) 
                {
                    ...
                    System.Collections.Generic.IEnumerable<string> _contents = (System.Collections.Generic.IEnumerable<string>)translator.GetObject(L, 2, typeof(System.Collections.Generic.IEnumerable<string>));
                        ...
                        var gen_ret = System.IO.File.WriteAllLinesAsync( _path, _contents );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 4&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& translator.Assignable<System.Collections.Generic.IEnumerable<string>>(L, 2)&& translator.Assignable<System.Text.Encoding>(L, 3)&& translator.Assignable<System.Threading.CancellationToken>(L, 4)) 
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                    System.Collections.Generic.IEnumerable<string> _contents = (System.Collections.Generic.IEnumerable<string>)translator.GetObject(L, 2, typeof(System.Collections.Generic.IEnumerable<string>));
                    System.Text.Encoding _encoding = (System.Text.Encoding)translator.GetObject(L, 3, typeof(System.Text.Encoding));
                    System.Threading.CancellationToken _cancellationToken;translator.Get(L, 4, out _cancellationToken);
                        ...
                        var gen_ret = System.IO.File.WriteAllLinesAsync( _path, _contents, _encoding, _cancellationToken );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& translator.Assignable<System.Collections.Generic.IEnumerable<string>>(L, 2)&& translator.Assignable<System.Text.Encoding>(L, 3)) 
                {
                    ...
                    System.Text.Encoding _encoding = (System.Text.Encoding)translator.GetObject(L, 3, typeof(System.Text.Encoding));
                        ...
                        var gen_ret = System.IO.File.WriteAllLinesAsync( _path, _contents, _encoding );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.IO.File.WriteAllLinesAsync!");
            
        }
        
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_AppendAllTextAsync_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    string _contents = LuaAPI.lua_tostring(L, 2);
                        ...
                        var gen_ret = System.IO.File.AppendAllTextAsync( _path, _contents );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 4&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& translator.Assignable<System.Text.Encoding>(L, 3)&& translator.Assignable<System.Threading.CancellationToken>(L, 4)) 
                {
                    ...
                    System.Threading.CancellationToken _cancellationToken;translator.Get(L, 4, out _cancellationToken);
                        ...
                        var gen_ret = System.IO.File.AppendAllTextAsync( _path, _contents, _encoding, _cancellationToken );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& translator.Assignable<System.Text.Encoding>(L, 3)) 
                {
                    ...
                    System.Text.Encoding _encoding = (System.Text.Encoding)translator.GetObject(L, 3, typeof(System.Text.Encoding));
                        ...
                        var gen_ret = System.IO.File.AppendAllTextAsync( _path, _contents, _encoding );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.IO.File.AppendAllTextAsync!");
            
        }
        
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_AppendAllLinesAsync_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& translator.Assignable<System.Collections.Generic.IEnumerable<string>>(L, 2)) 
                {
                    ...
                    System.Collections.Generic.IEnumerable<string> _contents = (System.Collections.Generic.IEnumerable<string>)translator.GetObject(L, 2, typeof(System.Collections.Generic.IEnumerable<string>));
                        ...
                        var gen_ret = System.IO.File.AppendAllLinesAsync( _path, _contents );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 4&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& translator.Assignable<System.Collections.Generic.IEnumerable<string>>(L, 2)&& translator.Assignable<System.Text.Encoding>(L, 3)&& translator.Assignable<System.Threading.CancellationToken>(L, 4)) 
                {
                    ...
                    System.Threading.CancellationToken _cancellationToken;translator.Get(L, 4, out _cancellationToken);
                        ...
                        var gen_ret = System.IO.File.AppendAllLinesAsync( _path, _contents, _encoding, _cancellationToken );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& translator.Assignable<System.Collections.Generic.IEnumerable<string>>(L, 2)&& translator.Assignable<System.Text.Encoding>(L, 3)) 
                {
                    ...
                    System.Text.Encoding _encoding = (System.Text.Encoding)translator.GetObject(L, 3, typeof(System.Text.Encoding));
                        ...
                        var gen_ret = System.IO.File.AppendAllLinesAsync( _path, _contents, _encoding );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.IO.File.AppendAllLinesAsync!");
		    ...
		    try {
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = System.IO.File.GetAccessControl( _path );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& translator.Assignable<System.Security.AccessControl.AccessControlSections>(L, 2)) 
                {
                    ...
                    System.Security.AccessControl.AccessControlSections _includeSections;translator.Get(L, 2, out _includeSections);
                        ...
                        var gen_ret = System.IO.File.GetAccessControl( _path, _includeSections );
                        translator.Push(L, gen_ret);

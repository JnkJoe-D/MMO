...
namespace XLua.CSObjectWrap
{
    ...
    public class LuaScriptWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(LuaScript);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to LuaScript constructor!");
        ...
        static int _m_Awake(RealStatePtr L)
        {
		    try {
                ...
                LuaScript gen_to_be_invoked = (LuaScript)translator.FastGetCSObj(L, 1);

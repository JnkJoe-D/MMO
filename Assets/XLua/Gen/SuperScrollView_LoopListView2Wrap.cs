...
namespace XLua.CSObjectWrap
{
    ...
    public class SuperScrollViewLoopListView2Wrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 28, 22, 10);
        ...
        static int _s_set_OnListViewStart(RealStatePtr L)
        {
		    try {
                ...
                SuperScrollView.LoopListView2 gen_to_be_invoked = (SuperScrollView.LoopListView2)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.OnListViewStart = translator.GetDelegate<System.Action<SuperScrollView.LoopListView2>>(L, 2);

...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp17(int p0, bool p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp18(int p0, int p1, long p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp19(UnityEngine.Vector2 p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public SuperScrollView.LoopListViewItem2 __Gen_Delegate_Imp20(SuperScrollView.LoopListView2 p0, int p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public SuperScrollView.LoopGridViewItem __Gen_Delegate_Imp21(SuperScrollView.LoopGridView p0, int p1, int p2, int p3)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
                ...
                SuperScrollView.LoopGridViewItem __gen_ret = (SuperScrollView.LoopGridViewItem)translator.GetObject(L, errFunc + 1, typeof(SuperScrollView.LoopGridViewItem));
                LuaAPI.lua_settop(L, errFunc - 1);
                return  __gen_ret;
#if THREAD_SAFE || HOTFIX_ENABLE
            }
		...
		public SuperScrollView.LoopStaggeredGridViewItem __Gen_Delegate_Imp22(SuperScrollView.LoopStaggeredGridView p0, int p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
                ...
                SuperScrollView.LoopStaggeredGridViewItem __gen_ret = (SuperScrollView.LoopStaggeredGridViewItem)translator.GetObject(L, errFunc + 1, typeof(SuperScrollView.LoopStaggeredGridViewItem));
                LuaAPI.lua_settop(L, errFunc - 1);
                return  __gen_ret;
#if THREAD_SAFE || HOTFIX_ENABLE
            }
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new System.Action<int, bool>(__Gen_Delegate_Imp17);
			}
		
		    if (type == typeof(System.Action<int, int, long>))
			{
			    return new System.Action<int, int, long>(__Gen_Delegate_Imp18);
			}
		
		    if (type == typeof(System.Action<UnityEngine.Vector2>))
			{
			    return new System.Action<UnityEngine.Vector2>(__Gen_Delegate_Imp19);
			}
		
		    if (type == typeof(UnityEngine.Events.UnityAction<UnityEngine.Vector2>))
			{
			    return new UnityEngine.Events.UnityAction<UnityEngine.Vector2>(__Gen_Delegate_Imp19);
			}
		
		    if (type == typeof(System.Func<SuperScrollView.LoopListView2, int, SuperScrollView.LoopListViewItem2>))
			{
			    return new System.Func<SuperScrollView.LoopListView2, int, SuperScrollView.LoopListViewItem2>(__Gen_Delegate_Imp20);
			}
		
		    if (type == typeof(System.Func<SuperScrollView.LoopGridView, int, int, int, SuperScrollView.LoopGridViewItem>))
			{
			    return new System.Func<SuperScrollView.LoopGridView, int, int, int, SuperScrollView.LoopGridViewItem>(__Gen_Delegate_Imp21);
			}
		
		    if (type == typeof(System.Func<SuperScrollView.LoopStaggeredGridView, int, SuperScrollView.LoopStaggeredGridViewItem>))
			{
			    return new System.Func<SuperScrollView.LoopStaggeredGridView, int, SuperScrollView.LoopStaggeredGridViewItem>(__Gen_Delegate_Imp22);
			}

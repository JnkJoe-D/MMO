...
namespace XLua.CSObjectWrap
{
    ...
    public class LuaLoopStaggeredGridViewItemWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(LuaLoopStaggeredGridViewItem);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new LuaLoopStaggeredGridViewItem();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to LuaLoopStaggeredGridViewItem constructor!");
        ...
        static int _m_Awake(RealStatePtr L)
        {
		    try {
                ...
                LuaLoopStaggeredGridViewItem gen_to_be_invoked = (LuaLoopStaggeredGridViewItem)translator.FastGetCSObj(L, 1);
        ...
        static int _s_set_stringInjectionArray(RealStatePtr L)
        {
		    try {
                ...
                LuaLoopStaggeredGridViewItem gen_to_be_invoked = (LuaLoopStaggeredGridViewItem)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.stringInjectionArray = (StringInjection[])translator.GetObject(L, 2, typeof(StringInjection[]));
        ...
        static int _s_set_objectInjectionArray(RealStatePtr L)
        {
		    try {
                ...
                LuaLoopStaggeredGridViewItem gen_to_be_invoked = (LuaLoopStaggeredGridViewItem)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.objectInjectionArray = (ObjectInjection[])translator.GetObject(L, 2, typeof(ObjectInjection[]));
        ...
        static int _s_set_arrayInjectionArray(RealStatePtr L)
        {
		    try {
                ...
                LuaLoopStaggeredGridViewItem gen_to_be_invoked = (LuaLoopStaggeredGridViewItem)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.arrayInjectionArray = (ArrayInjection[])translator.GetObject(L, 2, typeof(ArrayInjection[]));

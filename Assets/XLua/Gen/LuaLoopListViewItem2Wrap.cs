...
namespace XLua.CSObjectWrap
{
    ...
    public class LuaLoopListViewItem2Wrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(LuaLoopListViewItem2);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new LuaLoopListViewItem2();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to LuaLoopListViewItem2 constructor!");
        ...
        static int _m_Awake(RealStatePtr L)
        {
		    try {
                ...
                LuaLoopListViewItem2 gen_to_be_invoked = (LuaLoopListViewItem2)translator.FastGetCSObj(L, 1);

...
namespace XLua.CSObjectWrap
{
    ...
    public class LuaLoopGridViewItemWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(LuaLoopGridViewItem);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new LuaLoopGridViewItem();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to LuaLoopGridViewItem constructor!");
        ...
        static int _m_Awake(RealStatePtr L)
        {
		    try {
                ...
                LuaLoopGridViewItem gen_to_be_invoked = (LuaLoopGridViewItem)translator.FastGetCSObj(L, 1);

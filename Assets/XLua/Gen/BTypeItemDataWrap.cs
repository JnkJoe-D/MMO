...
namespace XLua.CSObjectWrap
{
    ...
    public class BTypeItemDataWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(BTypeItemData);
        ...
        {
            return LuaAPI.luaL_error(L, "BTypeItemData does not have a constructor!");
        }
        ...
        static int _g_get_type(RealStatePtr L)
        {
		    try {
                ...
                BTypeItemData gen_to_be_invoked = (BTypeItemData)translator.FastGetCSObj(L, 1);

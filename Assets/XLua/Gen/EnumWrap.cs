...
namespace XLua.CSObjectWrap
{
    ...
    public class ViewIdWrap
    {
		public static void __Register(RealStatePtr L)
        {
		    ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
		    Utils.BeginObjectRegister(typeof(ViewId), L, translator, 0, 0, 0, 0);
			Utils.EndObjectRegister(typeof(ViewId), L, translator, null, null, null, null, null);
			
			Utils.BeginClassRegister(typeof(ViewId), L, null, 10, 0, 0);

            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "None", ViewId.None);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "DemoUi", ViewId.DemoUi);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "SuperListUi", ViewId.SuperListUi);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "SuperGridUi", ViewId.SuperGridUi);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "LoginUi", ViewId.LoginUi);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "MainCityUi", ViewId.MainCityUi);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "DialogueUi", ViewId.DialogueUi);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "GuideUi", ViewId.GuideUi);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Max", ViewId.Max);
            

			Utils.RegisterFunc(L, Utils.CLS_IDX, "__CastFrom", __CastFrom);
            
            Utils.EndClassRegister(typeof(ViewId), L, translator);
        }
        ...
        static int __CastFrom(RealStatePtr L)
		{
            ...
            if (lua_type == LuaTypes.LUA_TNUMBER)
            {
                translator.PushViewId(L, (ViewId)LuaAPI.xlua_tointeger(L, 1));
            }
            ...
            else if(lua_type == LuaTypes.LUA_TSTRING)
            {
                ...
                {
                    translator.PushViewId(L, ViewId.None);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "DemoUi"))
                {
                    translator.PushViewId(L, ViewId.DemoUi);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "SuperListUi"))
                {
                    translator.PushViewId(L, ViewId.SuperListUi);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "SuperGridUi"))
                {
                    translator.PushViewId(L, ViewId.SuperGridUi);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "LoginUi"))
                {
                    translator.PushViewId(L, ViewId.LoginUi);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "MainCityUi"))
                {
                    translator.PushViewId(L, ViewId.MainCityUi);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "DialogueUi"))
                {
                    translator.PushViewId(L, ViewId.DialogueUi);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "GuideUi"))
                {
                    translator.PushViewId(L, ViewId.GuideUi);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "Max"))
                {
                    translator.PushViewId(L, ViewId.Max);
                }
				else
                {
                    return LuaAPI.luaL_error(L, "invalid string for ViewId!");
                }
            ...
            {
                return LuaAPI.luaL_error(L, "invalid lua type for ViewId! Expect number or string, got + " + lua_type);
            }

...
namespace XLua.CSObjectWrap
{
    ...
    public class SystemCollectionsGenericIList_1_SystemInt32_Wrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(System.Collections.Generic.IList<int>);
        ...
        {
            return LuaAPI.luaL_error(L, "System.Collections.Generic.IList<int> does not have a constructor!");
        }
        ...
        public static int __CSIndexer(RealStatePtr L)
        {
			try {
				...
				if (translator.Assignable<System.Collections.Generic.IList<int>>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					
					System.Collections.Generic.IList<int> gen_to_be_invoked = (System.Collections.Generic.IList<int>)translator.FastGetCSObj(L, 1);
        ...
        public static int __NewIndexer(RealStatePtr L)
        {
			...
			try {
				...
				if (translator.Assignable<System.Collections.Generic.IList<int>>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3))
				{

...
public class GameUi : MonoBehaviour
{
    ...
    public UiView ShowView(int viewId)
    {
        ...
        if (uiConfig != null && !string.IsNullOrEmpty(uiConfig.pathFilename))
        {
            ...
            if (uiView == null)
            {
                ...
                {
                    Debug.LogError(uiConfig.pathFilename + " can't be loaded!!!");
                }
            }
            else
            {
    ...
    public void SetRecordData(int viewId, object customData = null)
    {
        ClearRecordData();

        UIRecordData uiRecordData = new UIRecordData();
        uiRecordData.viewId = viewId;
        uiRecordData.customData = customData;
    ...
    public UIRecordData PopRecordData()
    {
        ...
        {
            UIRecordData uiRecordData = mRecordDataStack.Pop();
